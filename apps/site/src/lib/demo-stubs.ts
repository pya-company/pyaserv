...
const ROUTES: Array<{ match: RegExp; build: (path: string, init: RequestInit) => unknown | null }> = [
  ...
  { match: /^\/v1\/requests/, build: (_, init) => {
    ...
    return wrap([
      { id: 'demo-r-1', userId: 'demo-c-1', title: 'Necesito instalación de termotanque', titleEs: 'Necesito instalación de termotanque', titleEn: 'I need a thermostat installed', description: 'Compré un termotanque eléctrico 80L marca Sole. Necesito instalación profesional con factura. Disponibilidad sábado o domingo.', descriptionEs: 'Compré un termotanque eléctrico 80L marca Sole.', descriptionEn: 'I bought an 80L electric thermostat. Need professional installation.', category: 'plumbing', barrio: 'Carmelitas', budgetGs: 450000, status: 'open', createdAt: Math.floor(Date.now()/1000) - 86400 * 3 },
    { id: 'demo-r-2', userId: 'demo-c-2', title: 'Clases de inglés conversacional', titleEs: 'Clases de inglés conversacional', titleEn: 'Conversational English lessons', description: 'Necesito un profesor para clases de conversación 2 veces por semana. Nivel intermedio.', descriptionEs: 'Necesito un profesor para clases de conversación.', descriptionEn: 'Looking for a tutor for conversation classes twice a week.', category: 'teaching', barrio: 'Villa Morra', budgetGs: 250000, status: 'open', createdAt: Math.floor(Date.now()/1000) - 86400 * 1 },
    ])
  } },
