...
export const DICTS = {
  "es": {
    ...
    "demo.tour_home_step2_body": "Cambiá entre español, inglés, alemán o ruso desde el menú cuando quieras.",
  ...
  "en": {
    ...
    "demo.tour_home_step2_body": "Switch between Spanish, English, German and Russian from the menu whenever you like.",
  ...
  "de": {
    ...
    "demo.tour_home_step2_body": "Wechseln Sie über das Menü jederzeit zwischen Spanisch, Englisch, Deutsch und Russisch.",
  ...
  "ru": {
    ...
    "demo.tour_home_step2_body": "Переключайтесь между испанским, английским, немецким и русским через меню в любой момент.",
