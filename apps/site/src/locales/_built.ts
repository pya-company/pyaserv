...
export const DICTS = {
  "es": {
    ...
    "docs.screenshot_alt": "Captura de la feature en producción",
    ...
    "me.ext.cover_h": "Imagen de portada (URL)",
    "me.ext.services_h": "Servicios con precio",
    "me.ext.zones_h": "Zonas (hasta 8)",
    "me.ext.portfolio_h": "Portfolio (URLs de fotos)",
    "me.ext.schedule_h": "Horario",
    "me.ext.leadfilters_h": "Filtros de leads",
    "me.ext.budget_min": "Presupuesto mínimo (Gs)",
    "me.ext.budget_min_ph": "0 = sin filtro",
    "me.ext.hide_new": "Esconder cuentas creadas hace menos de 7 días (anti-spam)",
    "me.ext.guarani_h": "Guaraní (opcional)",
    "me.ext.guarani_phrase": "Frase corta en guaraní",
    "me.ext.guarani_bio": "Bio en guaraní",
    "me.ext.verification_h": "Verificación",
    "me.ext.ruc": "RUC (opcional)",
    ...
    "me.passkeys.h": "Seguridad — Passkeys",
    "me.passkeys.intro": "Iniciá sesión con Touch ID, Face ID, Windows Hello o el bloqueo de tu teléfono — sin código por email.",
    "me.passkeys.add": "+ Agregar passkey",
    "me.passkeys.empty": "No hay passkeys guardadas. Agregá una para iniciar sesión sin código.",
    "me.passkeys.delete_aria": "Eliminar passkey",
    "me.passkeys.unsupported": "Tu navegador no soporta passkeys.",
    "me.passkeys.saved": "Passkey guardada.",
    "me.passkeys.save_error": "No se pudo guardar la passkey.",
  ...
  "en": {
    ...
    "docs.screenshot_alt": "Screenshot of the feature in production",
    ...
    "me.ext.cover_h": "Cover image (URL)",
    "me.ext.services_h": "Services with price",
    "me.ext.zones_h": "Areas (up to 8)",
    "me.ext.portfolio_h": "Portfolio (photo URLs)",
    "me.ext.schedule_h": "Schedule",
    "me.ext.leadfilters_h": "Lead filters",
    "me.ext.budget_min": "Minimum budget (Gs)",
    "me.ext.budget_min_ph": "0 = no filter",
    "me.ext.hide_new": "Hide accounts created less than 7 days ago (anti-spam)",
    "me.ext.guarani_h": "Guaraní (optional)",
    "me.ext.guarani_phrase": "Short phrase in Guaraní",
    "me.ext.guarani_bio": "Bio in Guaraní",
    "me.ext.verification_h": "Verification",
    "me.ext.ruc": "RUC (optional)",
    ...
    "me.passkeys.h": "Security — Passkeys",
    "me.passkeys.intro": "Sign in with Touch ID, Face ID, Windows Hello or your phone's screen lock — no email code needed.",
    "me.passkeys.add": "+ Add passkey",
    "me.passkeys.empty": "No passkeys saved yet. Add one to sign in without a code.",
    "me.passkeys.delete_aria": "Delete passkey",
    "me.passkeys.unsupported": "Your browser does not support passkeys.",
    "me.passkeys.saved": "Passkey saved.",
    "me.passkeys.save_error": "Could not save the passkey.",
  ...
  "de": {
    ...
    "docs.screenshot_alt": "Screenshot des Features in Produktion",
    ...
    "me.ext.cover_h": "Titelbild (URL)",
    "me.ext.services_h": "Leistungen mit Preis",
    "me.ext.zones_h": "Gebiete (bis zu 8)",
    "me.ext.portfolio_h": "Portfolio (Foto-URLs)",
    "me.ext.schedule_h": "Zeiten",
    "me.ext.leadfilters_h": "Lead-Filter",
    "me.ext.budget_min": "Mindestbudget (Gs)",
    "me.ext.budget_min_ph": "0 = kein Filter",
    "me.ext.hide_new": "Konten ausblenden, die vor weniger als 7 Tagen erstellt wurden (Anti-Spam)",
    "me.ext.guarani_h": "Guaraní (optional)",
    "me.ext.guarani_phrase": "Kurzer Satz auf Guaraní",
    "me.ext.guarani_bio": "Bio auf Guaraní",
    "me.ext.verification_h": "Verifizierung",
    "me.ext.ruc": "RUC (optional)",
    ...
    "me.passkeys.h": "Sicherheit — Passkeys",
    "me.passkeys.intro": "Melde dich mit Touch ID, Face ID, Windows Hello oder der Bildschirmsperre deines Telefons an — kein E-Mail-Code nötig.",
    "me.passkeys.add": "+ Passkey hinzufügen",
    "me.passkeys.empty": "Noch keine Passkeys gespeichert. Füge einen hinzu, um dich ohne Code anzumelden.",
    "me.passkeys.delete_aria": "Passkey löschen",
    "me.passkeys.unsupported": "Dein Browser unterstützt keine Passkeys.",
    "me.passkeys.saved": "Passkey gespeichert.",
    "me.passkeys.save_error": "Passkey konnte nicht gespeichert werden.",
  ...
  "ru": {
    ...
    "docs.screenshot_alt": "Скриншот фичи в продакшене",
    "docs.btn_soon": "Скоро",
    ...
    "me.ext.cover_h": "Обложка (URL)",
    "me.ext.services_h": "Услуги с ценой",
    "me.ext.zones_h": "Районы (до 8)",
    "me.ext.portfolio_h": "Портфолио (URL фотографий)",
    "me.ext.schedule_h": "Часы работы",
    "me.ext.leadfilters_h": "Фильтры заявок",
    "me.ext.budget_min": "Минимальный бюджет (Gs)",
    "me.ext.budget_min_ph": "0 = без фильтра",
    "me.ext.hide_new": "Скрывать аккаунты младше 7 дней (антиспам)",
    "me.ext.guarani_h": "Гуарани (необязательно)",
    "me.ext.guarani_phrase": "Короткая фраза на гуарани",
    "me.ext.guarani_bio": "Био на гуарани",
    "me.ext.verification_h": "Верификация",
    "me.ext.ruc": "RUC (необязательно)",
    ...
    "me.passkeys.h": "Безопасность — Passkey",
    "me.passkeys.intro": "Входите с помощью Touch ID, Face ID, Windows Hello или блокировки экрана телефона — без кода из письма.",
    "me.passkeys.add": "+ Добавить passkey",
    "me.passkeys.empty": "Passkey ещё не сохранены. Добавьте один, чтобы входить без кода.",
    "me.passkeys.delete_aria": "Удалить passkey",
    "me.passkeys.unsupported": "Ваш браузер не поддерживает passkey.",
    "me.passkeys.saved": "Passkey сохранён.",
    "me.passkeys.save_error": "Не удалось сохранить passkey.",
